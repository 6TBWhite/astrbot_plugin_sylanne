...
WEIGHTS: dict[str, dict[str, float]] = {
    ...
    "needs.need_contact": {"idle": 0.2, "has_text": 0.03},
    ...
    "immunity.interruption_budget": {"idle": -0.04},
